...
package  main.java.org.shaderblowex.test.NFAA;
 ...
 * @author xxx
 */
public class NFAAFilterTest extends SimpleApplication  implements ActionListener {

  NFAAFilter nFAAFilter;
    
  BitmapText hintText;  
  BitmapText debugText; 
  boolean enabled=true;
  
 public   NFAAFilterTest()
    {
  ...
  public static void main(String[] args) {
        ...
        NFAAFilterTest app = new NFAAFilterTest();
         app.start();
