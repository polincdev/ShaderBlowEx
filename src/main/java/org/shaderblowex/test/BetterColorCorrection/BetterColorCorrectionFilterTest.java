...
package main.java.org.shaderblowex.test.BetterColorCorrection;
 ...
 * @author xxx
 */
public class BetterColorCorrectionFilterTest extends SimpleApplication  implements ActionListener {
 ...
 public   BetterColorCorrectionFilterTest()
    {
  ...
  public static void main(String[] args) {
        ...
        BetterColorCorrectionFilterTest app = new BetterColorCorrectionFilterTest();
         app.start();
